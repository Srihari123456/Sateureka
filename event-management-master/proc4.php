  ...
  if(isset($_POST['emp_id'])){
   ...
   $q0 = "SELECT `get_astronaut_role`('$emp_id') AS `get_astronaut_role`; ";
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
  ...
  margin-left: 100px;">
	...
	<h1 align="center">Astronaut Job</h1>
	</th>
	</tr>
	
	<TR>
		<TH border=" 1px solid #CCC">Astronaut</TH>
		<TH border=" 1px solid #CCC">Role</TH>
	</TR>
	...
	<td border=" 1px solid #CCC">
	<?php
	echo $rows['get_astronaut_role']; 	?>	</td>
