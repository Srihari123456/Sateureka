...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
  ...
  margin-left: 100px;">
	...
	<h1 align="center">FIT ASTRONAUTS</h1>
	</th>
	</tr>
	
	<TR>
		<TH border=" 1px solid #CCC">ASTRONAUT ID</TH>
		<TH border=" 1px solid #CCC">NAME</TH>
		<TH border=" 1px solid #CCC">WEIGHT( kg )</TH>
	</TR>
	...
	<?php
	echo $rows['astro_id']; 	?>	</td>
	
	<td border=" 1px solid #CCC">
	<?php
	echo $rows['Astro_name']; 	?>	</td>
	
	<td border=" 1px solid #CCC">
	<?php
	echo $rows['weight_kg']; 	?>	</td></tr>
		<?php } ?>
