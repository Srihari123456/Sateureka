...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
  ...
  margin-left: 50px;">
	...
	<h1 align="center">Query Manager</h1>
	</th>
	</tr>
	
	<TR> 
		<TH border=" 1px solid #CCC">ChatQuery</TH>
		<TH border=" 1px solid #CCC">Attention</TH> 
		<TH border=" 1px solid #CCC">Process</TH> 
	</TR>
	...
	<TR>
	<form action="query_noted.php" method = "POST" role="form">
	<td border=" 1px solid #CCC">
	<?php
	echo $rows['message']; 	?>	</td>
	<td>
	
	<input type="checkbox" name = "keytodelete" value = "<?php echo $rows['cid'];?> " >
