  ...
  include "static/cssjs/css.php";
   $q0 = "SELECT name,duration,count(emp_id) as InternCount FROM `intern` natural join `organisation` group by `name`,`duration`";
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap js-fullheight" style=" margin-top: 00px;
  ...
  margin-left: 50px;">
    ...
    border-spacing: 0;">
	<tr>
	<th colspan="5" border=" 1px solid #CCC" >
	<h1 align="center">Organization And Duration Based Intern Clasification</h1>
	</th>
	</tr>
	
	<TR> 
		<TH border=" 1px solid #CCC">Organization</TH>
		<TH border=" 1px solid #CCC">Duration</TH>
		<TH border=" 1px solid #CCC">InternCount</TH> 
	</TR>
	...
	<?php
	echo $rows['duration']; 	?>	</td>
	
	<td border=" 1px solid #CCC">
	<?php
	echo $rows['InternCount']; 	?>	</td>
    				...
    				<div class="single-slider owl-carousel ftco-animate">
    					<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(static/images/cs0199.jpg);">
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(static/images/_02199.jpg);">
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(static/images/cs03199.jpg);">
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(static/images/cs04199.jpg);">
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(static/images/cs05199.jpg);">
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(static/images/cs06199.jpg);">
