  ...
  include "static/cssjs/css.php";
   $q0 = "SELECT * FROM `internship` order by `emp_id` ";
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item cta"><a href="register.php" class="nav-link"><span>Log-in</span></a></li>
        </ul>
      </div>
    </div>
  </nav>
    ...
    <div class="hero-wrap js-fullheight" style=" margin-top: 00px;margin-left: 100px;">
	 <br><br><br>
    <!-- END nav -->
	...
	<h1 align="center">QUALIFIED INTERNS</h1>
	</th>
	</tr>
	
	<TR>
		<TH border=" 1px solid #CCC">ID</TH>
		<TH border=" 1px solid #CCC">NAME</TH>
		<TH border=" 1px solid #CCC">ORG.ID</TH>
		<TH border=" 1px solid #CCC">INSTITUTE NAME</TH>
