  ...
  if(isset($_POST['sate_id'])){
	$emp_id = $_POST['sate_id'];
  }
   $q0 = "SELECT `Payload_Proportion(in percentage)`('$emp_id') AS ` Payload_Proportion(in percentage)`; ";
...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	...
	<TR>
		...
		<TH border=" 1px solid #CCC">Payload Proportion(%)</TH>
	</TR>
	...
	<td border=" 1px solid #CCC">
	<?php
	echo $rows['Payload_Proportion(in percentage)']; 	?>	</td>
